  ...
  <div class="bg-base-100 border-b-2 border-base-content">
    <div class="container mx-auto px-4 py-3 flex flex-wrap items-center justify-between gap-3">
      <div class="flex items-center gap-3">
        <a href="/" title="Kruk.live" class="flex-shrink-0">
          <div class="bg-neutral-900 w-10 h-10 rounded-full shadow-lg flex items-center justify-center transition-transform hover:scale-110">
            <svg class="w-6 h-6 text-white" viewBox="0 0 1344 768" fill="currentColor">
    ...
    <div class="p-8 inline-block min-w-full min-h-full text-center">
      <div class="relative inline-block">
        <canvas
          ...
          {width}
          {height}
          class="block bg-white border-2 border-base-content shadow-lg"
