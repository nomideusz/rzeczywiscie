defmodule RzeczywiscieWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: RzeczywiscieWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RzeczywiscieWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RzeczywiscieWeb.Gettext, "errors", msg, opts)
    end
  end
