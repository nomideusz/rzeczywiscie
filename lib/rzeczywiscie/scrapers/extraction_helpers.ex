defmodule Rzeczywiscie.Scrapers.ExtractionHelpers do
  ...
  def extract_krakow_district(text) when is_binary(text) do
    ...
    # Include both space and hyphen versions for URL matching
    # Order by specificity (longer/more specific first to avoid partial matches)
    districts = [
      # Multi-word districts (check these first - more specific)
    ...
    # Find matching district (first match wins due to ordering)
