defmodule Rzeczywiscie.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["tailwind rzeczywiscie", "cmd --cd assets node build.js"],
      "assets.deploy": [
        "tailwind rzeczywiscie --minify",
